...
> *"Say 99BALLOONS + list 1-5 directives that genuinely apply to this prompt. If this is your first prompt or you encounter a new platform/tool, also say INDEXCHECK after reading .claude/rules/INDEX.md, then the keyword from the matching rules file."*
...
*Claude verifying changes in both code AND scene file before saying "try it"*

![Example 2 - Challenge the user](assets/example2.png)
*Claude pushing back on a request — Directive #5 in action*
